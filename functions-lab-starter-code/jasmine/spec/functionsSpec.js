describe("Title of testing arguments",function() {
    ...
    it("Testing the removeOdd() function", function(){
        ...
        expect(removeOdd([1,2,3,4,5,6,7])).toEqual([2,4,6]);
    });
    ...
    it("Testing the convertArrayToAnObject() function", function(){
        ...
        expect(convertArrayToAnObject(["ting","tang","tung","tong"])).toEqual({
            ting: "tang",
            tung: "tong"
        });
        // expect(convertArrayToAnObject(["ting","tang","tung","tong"])).toBe(Object);
